...
const openingWeekEl = document.getElementById('opening_hours_week')
const openingWeekendEl = document.getElementById('opening_hours_weekend')
const openingSundayEl = document.getElementById('opening_hours_sunday')
